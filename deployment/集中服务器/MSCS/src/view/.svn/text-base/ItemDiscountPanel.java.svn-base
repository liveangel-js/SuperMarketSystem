...
public class ItemDiscountPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btn_add);
        btn_add.setBounds(770, 270, 70, 30);
        ...
        text_promotionID.setBounds(630, 370, 120, 30);
        {
        	...
        	text_showItemInfo.setBounds(530, 50, 270, 100);
        }
        {
        	btn_cancel = new JButton();
        	this.add(btn_cancel);
        	btn_cancel.setText("\u53d6\u6d88");
        	btn_cancel.setBounds(770, 320, 70, 30);
        	btn_cancel.setFont(new java.awt.Font("微软雅黑",0,18));
        	btn_cancel.addActionListener(new ActionListener() {
        		public void actionPerformed(ActionEvent evt) {
        			System.out.println("btn_cancel.actionPerformed, event="+evt);
        ...
        text_specialPrice.setEditable(false);
        text_itemBegin.setEditable(false);
        text_itemEnd.setEditable(false);
        btn_add.setEnabled(false);
        text_showItemInfo.setEditable(false);
    ...
    private void btn_SureActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        text_specialPrice.setEditable(true);
        text_itemBegin.setEditable(true);
        text_itemEnd.setEditable(true);
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        text_specialPrice.setEditable(false);
        text_specialPrice.setText("");
        text_itemBegin.setEditable(false);
        text_itemBegin.setText("");
        text_itemEnd.setEditable(false);
        text_itemEnd.setText("");
        btn_add.setEnabled(false);
        btn_cancel.setEnabled(false);
    	update();
    }                                       
