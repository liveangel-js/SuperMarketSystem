...
public class SaleRecord extends Record  {
	...
	public void printBill(){
		try {
			...
			String string_point="积分使用:"+point+"\n";
			writer.write(string_point);
			String string_price="总价："+total_price+"\n";
			writer.write(string_price);
			String string_special_price="特价："+special_price+"\n";
			writer.write(string_special_price);
			String string_pay_price="支付："+pay+"\n";
			writer.write(string_pay_price);
			String string_payback_price="找零："+(String.format("%.2f",payback))+"\n";
