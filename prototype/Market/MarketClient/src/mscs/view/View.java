...
// TODO add your handling code here:
    if(evt.getKeyCode()==KeyEvent.VK_ENTER){
        String uid = this.customerID.getText();
         try{
        //获得用户信息
            user = this.saleControl.getUserInfo(Integer.parseInt(uid));
         }catch(Exception e){
...
// TODO add your handling code here:
    if(evt.getKeyCode()==KeyEvent.VK_ENTER){
        ...
        CommidityRecord g = null;
         try{
        //获得用户信息
            g = this.saleControl.getGoodInfo(Integer.parseInt(gid));
         }catch(Exception e){
...
private void handleAddItem(){
        ...
        this.saleControl.addItem(Integer.parseInt(gid), gname,Double.parseDouble(price),Integer.parseInt(num));
...
// TODO add your handling code here:
    double sum = this.saleControl.buy();
